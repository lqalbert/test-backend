        ...
        <el-row>
            <el-col :span="24">
                ...
                >
                    ...
                    <el-table-column prop="branch_name" label="分类名称" align="center" ></el-table-column>
...
<script>
    ...
    import PacketAjaxProxy from '@/api/coursebranch'
    import Edit from './EditBranch'
    import Add from './AddBranch'
