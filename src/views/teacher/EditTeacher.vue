        ...
        <myDialog title="编辑直播间" :name="name" :width="width" :height="height" @before-open="onOpen">
            <el-form :model="editForm" ref="editForm" :rules="rules" :label-width="labelWidth" :label-position="labelPosition">
                <el-form-item label="讲师" prop="teacher_name">
                    <el-input size="small" placeholder="讲师" v-model="editForm.teacher_name"></el-input>
                </el-form-item>
                <el-form-item label="简介" prop="introduction">
                    <el-input size="small" placeholder="简介" v-model="editForm.introduction"></el-input>
                </el-form-item>
                <el-form-item label="证书编号" prop="code_book">
                    <el-input size="small" placeholder="证书编号" v-model="editForm.code_book"></el-input>
                </el-form-item>
                <el-form-item label="关注人数" prop="focus_number">
                    <el-input size="small" placeholder="关注人数" v-model="editForm.focus_number"></el-input>
                </el-form-item>

                <el-form-item label="称号" prop="teacher_title">
                    <el-select v-model="editForm.teacher_title" placeholder="请选择">
                        <el-option
...
export default {
    ...
    data() {
        return {
            ...
            rules: {
                ...
                focus_number: [
                    { required: true, message: '必须填写', trigger: 'blur' },
                    { pattern: /^\d+(\.{0,1}\d+){0,1}$/, message: '非负数字' }
    ...
    methods: {
        ...
        onOpen(model){
            ...
            this.imgURL=this.editForm.teacher_img
            this.teacherTitleList=model.params.List[1];
        }
    },
    watch: {
