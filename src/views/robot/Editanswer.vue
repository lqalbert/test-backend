<template>
    <div>
        <myDialog title="修改问题" :name="name" :width="width" :height="height" @before-open="onOpen">
            <el-form :model="editForm" ref="editForm" :rules="rules" :label-width="labelWidth" :label-position="labelPosition">
                <el-form-item label="标题" prop="title">
                    <el-input size="small" placeholder="标题" v-model="editForm.title"></el-input>
                </el-form-item>
                <el-form-item label="内容" prop="content">
                    <el-input type="textarea" size="small" placeholder="内容" v-model="editForm.content"></el-input>
                </el-form-item>
